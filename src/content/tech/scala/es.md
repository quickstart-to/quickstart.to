---
title: "Scala"
description: "Programacion funcional en JVM - impulsa Apache Spark para big data con tipado fuerte e interop Java"
template: "language"
...
**Comparación**:
| Aspecto | Scala | Kotlin | Java |
|--------|-------|--------|------|
| Paradigma | FP + OOP | OOP + FP | OOP |
| Aprendizaje | Difícil | Fácil | Fácil |
| Verbosidad | Baja | Baja | Alta |
| Ecosistema | Spark | Android | Enterprise |
