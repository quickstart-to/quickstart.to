...
**What**: Framework for building applications powered by language models.

**Why**: Chain LLM calls, connect to data sources, agents, memory management.
...
result = chain.invoke({"input": "Hello"})  # Returns string
...
- [LangGraph](https://langchain-ai.github.io/langgraph/) - Complex workflows
