---
title: "SQLAlchemy"
description: "Python SQL-Toolkit und ORM - flexible Abfragen, Beziehungen, Async-Support, Multi-DB"
template: "tool"
...
|---------|-------------|
| `Engine` | Datenbankverbindung |
| `Session` | Arbeitseinheit |
| `Model` | Tabellenzuordnung |
| `Column` | Felddefinition |
| `relationship` | Modellbeziehungen |
| `Query` | Datenabfrage |
...
- [SQLAlchemy Documentation](https://docs.sqlalchemy.org/) - Offizielle Dokumentation
- [ORM Tutorial](https://docs.sqlalchemy.org/en/20/tutorial/) - Erste Schritte
- [ORM Quickstart](https://docs.sqlalchemy.org/en/20/orm/quickstart.html) - Schnelleinstieg
- [Alembic](https://alembic.sqlalchemy.org/) - Migrationen
