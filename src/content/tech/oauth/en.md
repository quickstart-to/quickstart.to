...
**What**: Authorization framework that enables third-party apps to access resources without sharing passwords.

**Why**: Secure delegated access, industry standard, supports various grant types for different scenarios.
...
- [OAuth 2.0 Specification](https://oauth.net/2/) - Official spec
- [OAuth 2.0 Playground](https://developers.google.com/oauthplayground) - Interactive testing
- [Auth0 Documentation](https://auth0.com/docs) - Implementation guides
- [PKCE RFC](https://oauth.net/2/pkce/) - PKCE specification
