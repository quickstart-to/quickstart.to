---
title: "OAuth 2.0"
description: "Framework de autorizacion para acceso delegado - Authorization Code, PKCE, Client Credentials"
template: "tool"
...
**Qué**: Framework de autorización que permite a apps de terceros acceder a recursos sin compartir contraseñas.

**Por qué**: Acceso delegado seguro, estándar de la industria, soporta varios tipos de grant para diferentes escenarios.
...
- [OAuth 2.0 Specification](https://oauth.net/2/) - Especificación oficial
- [OAuth 2.0 Playground](https://developers.google.com/oauthplayground) - Pruebas interactivas
- [Auth0 Documentation](https://auth0.com/docs) - Guías de implementación
- [PKCE RFC](https://oauth.net/2/pkce/) - Especificación PKCE
