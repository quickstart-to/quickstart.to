...
**Was**: Autorisierungs-Framework, das Drittanbieter-Apps den Zugriff auf Ressourcen ohne Passwort-Weitergabe ermöglicht.

**Warum**: Sichere delegierte Zugriffe, Industriestandard, unterstützt verschiedene Grant-Types für unterschiedliche Szenarien.
...
|------------|----------|
| Authorization Code | Web-Apps mit Backend |
| Authorization Code + PKCE | Mobile/SPA-Apps |
| Client Credentials | Machine-to-Machine |
| Refresh Token | Abgelaufene Tokens erneuern |
...
- [OAuth 2.0 Specification](https://oauth.net/2/) - Offizielle Spezifikation
- [OAuth 2.0 Playground](https://developers.google.com/oauthplayground) - Interaktives Testen
- [Auth0 Documentation](https://auth0.com/docs) - Implementierungsanleitungen
- [PKCE RFC](https://oauth.net/2/pkce/) - PKCE-Spezifikation
