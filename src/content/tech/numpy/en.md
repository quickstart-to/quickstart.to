...
**What**: Fundamental package for scientific computing with Python.

**Why**: Fast array operations, broadcasting, linear algebra, foundation for data science.
...
| Shape | `arr.shape`, `arr.reshape(2, 3)` |
...
- [NumPy Cheat Sheet](https://numpy.org/doc/stable/user/cheatsheet.html) - Reference
